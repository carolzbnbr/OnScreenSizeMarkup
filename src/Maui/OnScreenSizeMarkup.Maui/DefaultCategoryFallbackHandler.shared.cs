...
{
	internal ScreenCategories Category { get; set; }
...
public ScreenCategories GetCategoryByDeviceModel(string deviceModel)
{
	...
	if (modelCategories.TryGetValue(deviceNameLocal, out var category))
	{
		return category;
	}

...
namespace OnScreenSizeMarkup.Forms.Extensions
{
    public static class ScreenCategoryExtension
    {
        ...
        private static bool TryGetCategory(out ScreenCategories category)
        {
            ...
            var log =$"{nameof(OnScreenSizeExtension)} - Screen-Category:{category} - Physical-Device-Size:{DeviceDisplay.MainDisplayInfo.Width}x{DeviceDisplay.MainDisplayInfo.Height}"; 

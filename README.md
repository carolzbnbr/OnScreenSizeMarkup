...
The .NET MAUI library has been separated inon its own repository. If you are looking for the library for .NET MAUI, please go [here]([repository_link](https://github.com/carolzbnbr/OnScreenSizeMarkup.Maui)).
